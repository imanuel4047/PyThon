...
class Parkir():
    ...
    def createHome(self):
        ...
        #biaya per jam 2000
        Label(self.root, text="Biaya Per Jam", font=('Comic Sans', 20), fg="red").place(x=350, y=68)
        Label(self.root, text="Rp. 2.000", font=('Comic Sans', 35), fg="red").place(x=350, y=105)
        #---------------- treeview section -----------------#
        #label
        Label(self.root, text="List Pelanggan Urut Terakhir Keluar", font=('Comic Sans', 10), fg="blue").place(x=17, y=240)
        Label(self.root, text="List Pelanggan Banyak Bayar", font=('Comic Sans', 10), fg="blue").place(x=347, y=240)
        self.DataTreeview1()
        self.DataTreeview2()
